...
public class AvailableEntitiesPage2 {
	
	ResourceBundle rb=ResourceBundle.getBundle("elementlocator");

	FirefoxDriver driver;
	public AvailableEntitiesPage2(FirefoxDriver driver){
	this.driver=driver;
}
	...
	public void user() throws FindFailed, InterruptedException{
		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(rb.getString("syncComplete_entityadded_xpath"))));
			
			//WebElement element=wait.until(ExpectedConditions.visibilityOfElementLocated(rb.getString("syncComplete_entityadded_xpath")));
